    ...
    $.fn.graspSchedule = function (paramData) {
        ...
        var getEventHight = function (eventId) {
            ...
            if(paramData.options.insideTime){
                jqueryThis.append("<div class='" + paramData.options.classnames.event + "' id='" + id2 + "' onclick='" + paramData.events[eventId].onclick + "'>" + paramData.events[eventId].title + "<br>" + paramData.events[eventId].date + "</div>");
            } else {
                jqueryThis.append("<div class='" + paramData.options.classnames.event + "' id='" + id2 + "' onclick='" + paramData.events[eventId].onclick + "'>" + paramData.events[eventId].title + "</div>");
            }
        ...
        var getScheduleHight = function (scheduleId) {
            ...
            if(paramData.options.insideTime){
                jqueryThis.append("<div class='" + paramData.options.classnames.schedule + "' id='" + id2 + "' onclick='" + paramData.schedules[scheduleId].onclick + "'>" + paramData.schedules[scheduleId].title + "<br>" + paramData.schedules[scheduleId].start + "-" + paramData.schedules[scheduleId].end + "</div>");
            } else {
                jqueryThis.append("<div class='" + paramData.options.classnames.schedule + "' id='" + id2 + "' onclick='" + paramData.schedules[scheduleId].onclick + "'>" + paramData.schedules[scheduleId].title + "</div>");
            }
            var height = $("#" + id2).css("height");
            $("#" + id2).remove();
            return extractNum(height);
        ...
        var graspSchedule = {
            ...
            drawEvent: function (id) {
                ...
                if(paramData.options.insideTime){
                    jqueryThis.append("<div class='" + paramData.options.classnames.event + "' id='" + id2 + "' onclick='" + paramData.events[eventId].onclick + "'>" + paramData.events[id].title + "<br>" + comDateFormat(paramData.events[id].date) + "</div>");
                }else{
                    jqueryThis.append("<div class='" + paramData.options.classnames.event + "' id='" + id2 + "' onclick='" + paramData.events[eventId].onclick + "'>" + paramData.events[id].title + "</div>");
                }
                var css = {};
            ...
            drawSchedule: function (id) {
                ...
                css.position = "absolute";
                if(paramData.options.insideTime){
                    jqueryThis.append("<div class='" + paramData.options.classnames.schedule + "' id='" + id2 + "' onclick='" + paramData.schedules[id].onclick + "'>" + paramData.schedules[id].title + "<br>" + comDateFormat(paramData.schedules[id].start) + " - " + comDateFormat(paramData.schedules[id].end) + "</div>");
                }else{
                    jqueryThis.append("<div class='" + paramData.options.classnames.schedule + "' id='" + id2 + "' onclick='" + paramData.schedules[id].onclick + "'>" + paramData.schedules[id].title + "</div>");
                }
                $("#" + id2).css(css);
